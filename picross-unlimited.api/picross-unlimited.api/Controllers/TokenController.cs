...
namespace Picross_Unlimited.Api.Controllers;
        ...
        [Route("[controller]")]
        [ApiController]
public class TokenController(AppDbContext context, UserManager<AppUser> userManager, JwtConfiguration jwtConfiguration, RoleManager<IdentityRole> roleManager) : ControllerBase
{
    public AppDbContext _context = context;
    public UserManager<AppUser> _userManager = userManager;
    public JwtConfiguration _jwtConfiguration = jwtConfiguration;
